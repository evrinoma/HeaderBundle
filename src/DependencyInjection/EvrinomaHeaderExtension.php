...
class EvrinomaHeaderExtension extends Extension
{
    ...
    public const ENTITY = 'Evrinoma\HeaderBundle\Entity';
    public const MODEL = 'Evrinoma\HeaderBundle\Model';
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if (self::ENTITY_FACTORY_HEADER !== $config['factory']) {
    ...
    private function wireConstraintTag(ContainerBuilder $container): void
    {
        foreach ($container->getDefinitions() as $key => $definition) {
            switch (true) {
                case str_contains($key, HeaderPass::HEADER_CONSTRAINT)   :
                    $definition->addTag(HeaderPass::HEADER_CONSTRAINT);
                    break;
                default:
            }
        }
